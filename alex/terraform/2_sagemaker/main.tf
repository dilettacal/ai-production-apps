...
# Construct the SageMaker image URI based on the region
locals {
  sagemaker_image_uri = "763104351884.dkr.ecr.${var.aws_region}.amazonaws.com/huggingface-pytorch-inference:${var.sagemaker_image_tag}"
}
